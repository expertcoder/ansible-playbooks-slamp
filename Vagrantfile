...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.network "private_network", ip: "33.33.33.107"
    config.vm.network "public_network", ip: "192.168.1.107"

    #this disable the default builtin synced folder
    config.vm.synced_folder ".", "/vagrant", disabled: true

    config.vm.synced_folder "/work/elliance/symfony", "/var/www/symfony", type: "nfs"
    #config.vm.synced_folder "/work/elliance/front", "/var/www/front", type: "nfs"
    ...
    config.vm.synced_folder "/work/elliance/dynamic-files", "/var/www/dynamic-files", type: "nfs"

    #shared-files folder is a convient way to share files between the host and the virtual machine. Memcache places files here.
    config.vm.synced_folder "/work/elliance/shared-files", "/var/www/shared-files", type: "nfs"
